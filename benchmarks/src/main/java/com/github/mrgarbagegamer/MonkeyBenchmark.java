...
//     private static List<Long> MASKS;
...
//         MASKS = StartYourMonkeys.GlobalConfig.CLICK_TO_TRUE_CELL_MASK;
...
//         return (prefixMask ^ MASKS.get(finalClick)) == EXPECTED;
//     }
...
//             if ((prefixMask ^ MASKS.get(finalClick)) == EXPECTED) {
//                 validCount++;
//             }
//         }
